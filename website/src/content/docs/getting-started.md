...
:::note
henri was revived in 2026 on a modern toolchain (Node 22+, Express 5, Next.js 15, React 19, Mongoose 8, Sequelize 6). Releases published to npm before that revival still target Node 10 to 14; make sure you install a current version.
:::
