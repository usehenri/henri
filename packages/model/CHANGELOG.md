...
**Note:** Version bump only for package @usehenri/model
...
* **model:** removing waterline support and adding mongoose ([8438dce](https://github.com/usehenri/henri/commit/8438dce))
