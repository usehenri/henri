/**
 * Route helpers shared by useHenri and the form helpers (same contract as
 * @usehenri/react). `paths` is the object injected by henri's router, keyed
 * by `${action}_${controller}_path`, ex: { show_tasks_path: { method, route } }.
 */
