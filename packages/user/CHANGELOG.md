...
**Note:** Version bump only for package @usehenri/user
...
* **user:** need to use another method in passport-jwt 3.0.0 ([91938cc](https://github.com/usehenri/henri/commit/91938cc))
