...
**Note:** Version bump only for package @usehenri/log
...
* **log:** fatalError should throw ([d2f8820](https://github.com/usehenri/henri/commit/d2f8820))


### Features

* **log:** add log.fatalError to properly display error msg and exit ([2e041e9](https://github.com/usehenri/henri/commit/2e041e9))
...
* **log:** prefix the filename with correct folder ([3375f6d](https://github.com/usehenri/henri/commit/3375f6d))
