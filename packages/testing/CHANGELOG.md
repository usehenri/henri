...
- [#425](https://github.com/usehenri/henri/pull/425) [`5fe2e81`](https://github.com/usehenri/henri/commit/5fe2e819b51498d8a28f16f327e9bc1055288c05) Thanks [@reel](https://github.com/reel)! - An inbox and a queue a test can read: `inbox()` and `enqueued()`.
