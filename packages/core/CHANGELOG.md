...
- [#438](https://github.com/usehenri/henri/pull/438) [`4dff51e`](https://github.com/usehenri/henri/commit/4dff51edc050e29398c793a5aedb48776b7b7119) Thanks [@reel](https://github.com/reel)! - `config.policies.anonymous`: the half of the refusal oracle that was left open.
...
- [#430](https://github.com/usehenri/henri/pull/430) [`60dbf33`](https://github.com/usehenri/henri/commit/60dbf33c2a4f14e328a0df1cb44be061e15431e5) Thanks [@reel](https://github.com/reel)! - An asset prefix that also fixes the Content Security Policy, and the seam a CSS inliner plugs into.
...
- [#441](https://github.com/usehenri/henri/pull/441) [`3d6f3fc`](https://github.com/usehenri/henri/commit/3d6f3fc048d05db41be86069608d342e437408cb) Thanks [@reel](https://github.com/reel)! - `config.csp.add`, so adding one script origin no longer takes the rest of the policy with it.
...
- [#416](https://github.com/usehenri/henri/pull/416) [`c8f5367`](https://github.com/usehenri/henri/commit/c8f53678b33341d086b467f801e959314afc7860) Thanks [@reel](https://github.com/reel)! - A declared filter and sort surface for an index action.
...
- [#428](https://github.com/usehenri/henri/pull/428) [`49398a6`](https://github.com/usehenri/henri/commit/49398a6308f0760f01c6ff2ec98aaa35f484474d) Thanks [@reel](https://github.com/reel)! - `_embedded`: a record's relations, in the answer that already holds it.
...
- [#432](https://github.com/usehenri/henri/pull/432) [`cee57b9`](https://github.com/usehenri/henri/commit/cee57b9d3521a4a70c715222eae1f18ff4a6c128) Thanks [@reel](https://github.com/reel)! - Types generated from what the application already declares.
...
- [#417](https://github.com/usehenri/henri/pull/417) [`d88bf7f`](https://github.com/usehenri/henri/commit/d88bf7fe038a6b58e7bed02ff4c90755f6c0e65e) Thanks [@reel](https://github.com/reel)! - Maintenance mode, and `henri runner`: the two things an operator had no way to do.
...
- [#444](https://github.com/usehenri/henri/pull/444) [`61bf75c`](https://github.com/usehenri/henri/commit/61bf75cbaccda1aecff34408a175b2d85447d7a8) Thanks [@reel](https://github.com/reel)! - `henri types` describes a model by the adapter of its store, and closes the one it can
...
- [#431](https://github.com/usehenri/henri/pull/431) [`bd1b630`](https://github.com/usehenri/henri/commit/bd1b63083b3817b8c47b8a187de76027458a1b32) Thanks [@reel](https://github.com/reel)! - The documentation ships with the framework, and `henri docs` reads it.
...
- [#423](https://github.com/usehenri/henri/pull/423) [`27b5513`](https://github.com/usehenri/henri/commit/27b5513d1cae8aba734fe27da0ace2a82423e2f4) Thanks [@reel](https://github.com/reel)! - Time zones: `config.timeZone`, a person's zone on their record, and a mail's zone that is the recipient's
...
- [#418](https://github.com/usehenri/henri/pull/418) [`1103628`](https://github.com/usehenri/henri/commit/110362808f8ec6d73a75ff7fc89a77f3e943d773) Thanks [@reel](https://github.com/reel)! - A refused record and a record that is not there answer the same 404.
...
- [#428](https://github.com/usehenri/henri/pull/428) [`49398a6`](https://github.com/usehenri/henri/commit/49398a6308f0760f01c6ff2ec98aaa35f484474d) Thanks [@reel](https://github.com/reel)! - `res.csv()`: an export that streams, and leaves through the same gate as every other answer.
...
- [#439](https://github.com/usehenri/henri/pull/439) [`ec64e44`](https://github.com/usehenri/henri/commit/ec64e44e7b79a02da5fc587a72a9a6c900836982) Thanks [@reel](https://github.com/reel)! - `res.stream()` and `henri.streams`: real time as server-sent events, with the policy asked on every event — and `@usehenri/websocket` deleted.
...
- [#421](https://github.com/usehenri/henri/pull/421) [`b7f33e2`](https://github.com/usehenri/henri/commit/b7f33e28a5e4844391befd75d08e42c4cf6212ed) Thanks [@reel](https://github.com/reel)! - A wrong configuration value says what to do about it, and the instructions are checked against the source that owns them.
...
- [#444](https://github.com/usehenri/henri/pull/444) [`61bf75c`](https://github.com/usehenri/henri/commit/61bf75cbaccda1aecff34408a175b2d85447d7a8) Thanks [@reel](https://github.com/reel)! - `henri doctor` checks that the documentation the packages ship is installed
